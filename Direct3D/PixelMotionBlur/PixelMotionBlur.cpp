...
INT WINAPI wWinMain( HINSTANCE, HINSTANCE, LPWSTR, int )
{
    ...
    {
        g_pScene1Object[iObject]->~OBJECT();
        _aligned_free(g_pScene1Object[iObject]);
    }

    for( iObject = 0; iObject < NUM_WALLS; iObject++ )
    {
        g_pScene2Object[iObject]->~OBJECT();
        _aligned_free(g_pScene2Object[iObject]);
    }
...
void InitApp()
{
    ...
    for( iObject = 0; iObject < NUM_OBJECTS; iObject++ )
    {
        void* data = _aligned_malloc(sizeof(OBJECT), 16);
        g_pScene1Object[iObject] = new (data) OBJECT;
    ...
    {
        void* data = _aligned_malloc(sizeof(OBJECT), 16);
        g_pScene2Object[iObject] = new (data) OBJECT;
