...
HRESULT CAllocateHierarchy::CreateFrame( LPCSTR Name, D3DXFRAME** ppFrameOut )
{
    ...
    // Create a new frame that is 16 byte aligned
    void* data = _aligned_malloc(sizeof(D3DXFRAME_DERIVED), 16);
    D3DXFRAME_DERIVED* pNewFrame = new (data) D3DXFRAME_DERIVED;
