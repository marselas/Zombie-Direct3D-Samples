...
INT WINAPI wWinMain( HINSTANCE, HINSTANCE, LPWSTR, int )
{
    ...
    catch( exception e )
    {
        ...
        wsz[ 255 ] = 0;
        DXUTTrace( _T(__FILE__), ( DWORD )__LINE__, E_FAIL, wsz, true );
    }
                        ...
                        D3DXMATRIX* pWorld, UINT nRenderPass, CInstance** ppInstance )
{
    ...
    void* data = _aligned_malloc(sizeof(CInstance), 16);
    CInstance* pInstance = new (data) CInstance(pMesh, pWorld, nRenderPass);
