                          ...
                          IDirect3DTexture9* pArrowTex )
{
    ...
    txtHelper.Begin();
    {
        ...
        Luminance::g_pTexLuminance[ 4 ]->GetLevelDesc( 0, &desc );

        WCHAR str[100];
        swprintf_s( str, 100, L"%dx%d", desc.Width, desc.Height );
        txtHelper.DrawTextLine( str );
    }
    txtHelper.End();
    ...
    txtHelper.Begin();
    {
        ...
        D3DSURFACE_DESC desc;
        Luminance::g_pTexLuminance[ 3 ]->GetLevelDesc( 0, &desc );
    ...
    txtHelper.Begin();
    {
        ...
        D3DSURFACE_DESC desc;
        Luminance::g_pTexLuminance[ 2 ]->GetLevelDesc( 0, &desc);
    ...
    txtHelper.Begin();
    {
        ...
        D3DSURFACE_DESC desc;
        Luminance::g_pTexLuminance[ 1 ]->GetLevelDesc( 0, &desc );
    ...
    txtHelper.Begin();
    {
        ...
        D3DSURFACE_DESC desc;
        Luminance::g_pTexLuminance[ 0 ]->GetLevelDesc( 0, &desc );
