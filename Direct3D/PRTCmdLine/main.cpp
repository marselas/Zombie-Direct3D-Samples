                    ...
                    CONCAT_MESH* pPRTMesh, CONCAT_MESH* pBlockerMesh, SETTINGS* pSettings )
{
    ...
    if( dwNumMeshes > 0 )
    {
        ...
        for( DWORD dwMesh = 0; dwMesh < dwNumMeshes; dwMesh++ )
        {
            dwNumVerts += blockerMeshArray[dwMesh]->GetNumVertices();
            dwNumFaces += blockerMeshArray[dwMesh]->GetNumFaces();
        }
    ...
    if( dwNumMeshes > 0 )
    {
        ...
        for( DWORD dwMesh = 0; dwMesh < dwNumMeshes; dwMesh++ )
        {
            dwNumVerts += prtMeshArray[dwMesh]->GetNumVertices();
            dwNumFaces += prtMeshArray[dwMesh]->GetNumFaces();
        }
