...
INT_PTR CALLBACK DisplaySwitchToREFWarningProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_INITDIALOG:
        ...
        WCHAR sz[512];
        swprintf_s(sz, 512,
            L"This program needs to use the Direct3D %lld reference device.  This device implements the entire Direct3D %lld feature set, but runs very slowly.  Do you wish to continue?", 
            static_cast<__int64>(lParam), static_cast<__int64>(lParam));
