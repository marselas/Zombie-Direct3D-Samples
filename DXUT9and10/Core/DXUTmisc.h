...
#define DXUT_ERR(str,hr)           DXUTTrace( _T(__FILE__), (DWORD)__LINE__, hr, str, false )
#define DXUT_ERR_MSGBOX(str,hr)    DXUTTrace( _T(__FILE__), (DWORD)__LINE__, hr, str, true )
