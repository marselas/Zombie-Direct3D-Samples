...
const WCHAR *DXGetErrorString(HRESULT hr)
{
    switch (hr)
    {
    case D3D_OK: return L"NO ERROR";
    case D3DERR_WRONGTEXTUREFORMAT: return L"WRONG TEXTURE FORMAT";
    case D3DERR_UNSUPPORTEDCOLOROPERATION: return L"UNSUPPORTED COLOR OPERATION";
    case D3DERR_UNSUPPORTEDCOLORARG: return L"UNSUPPORTED COLOR ARG";
    case D3DERR_UNSUPPORTEDALPHAOPERATION: return L"UNSUPPORTED ALPHA OPERATION";
    case D3DERR_UNSUPPORTEDALPHAARG: return L"UNSUPPORTED ALPHA ARG";
    case D3DERR_TOOMANYOPERATIONS: return L"TOO MANY OPERATIONS";
    case D3DERR_CONFLICTINGTEXTUREFILTER: return L"CONFLICTING TEXTURE FILTER";
    case D3DERR_UNSUPPORTEDFACTORVALUE: return L"UNSUPOPPORTED FACTOR VALUE";
    case D3DERR_CONFLICTINGRENDERSTATE: return L"CONFLICTING RENDER STATE";
    case D3DERR_UNSUPPORTEDTEXTUREFILTER: return L"UNSUPPORTED TEXTURE FILTER";
    case D3DERR_CONFLICTINGTEXTUREPALETTE: return L"CONFLICTING TEXTURE PALETTE";
    case D3DERR_DRIVERINTERNALERROR: return L"DRIVER INTERNAL ERROR";
    case D3DERR_NOTFOUND: return L"NOT FOUND";
    case D3DERR_MOREDATA: return L"MORE DATA";
    case D3DERR_DEVICELOST: return L"DEVICE LOST";
    case D3DERR_DEVICENOTRESET: return L"DEVICE NOT REST";
    case D3DERR_NOTAVAILABLE: return L"NOT AVAILABLE";
    case D3DERR_OUTOFVIDEOMEMORY: return L"OUT OF VIDEO MEMORY";
    case D3DERR_INVALIDDEVICE: return L"INVALID DEVICE";
    case D3DERR_INVALIDCALL: return L"INVALID CALL";
    case D3DERR_DRIVERINVALIDCALL: return L"DRIVER INVALID CALL";
    case D3DERR_WASSTILLDRAWING: return L"WAS STILL DRAWING";
    case D3DOK_NOAUTOGEN: return L"NO AUTOGEN";
    case D3DERR_DEVICEREMOVED: return L"DEVICE REMOVED";
    case S_NOT_RESIDENT: return L"NOT RESIDENT";
    case S_RESIDENT_IN_SHARED_MEMORY: return L"RESIDENT IN SHARED MEMORY";
    case S_PRESENT_MODE_CHANGED: return L"PRESENT MODE CHANGED";
    case S_PRESENT_OCCLUDED: return L"PRESENT OCCLUDED";
    case D3DERR_DEVICEHUNG: return L"DEVICE HUNG";
    case D3DERR_UNSUPPORTEDOVERLAY: return L"UNSUPPORTED OVERLAY";
    case D3DERR_UNSUPPORTEDOVERLAYFORMAT: return L"UNSUPPORTED OVERLAY FORMAT";
    case D3DERR_CANNOTPROTECTCONTENT: return L"CANNOT PROTECT CONTENT";
    case D3DERR_UNSUPPORTEDCRYPTO: return L"UNSUPPORTED CRYPTO";
    case D3DERR_PRESENT_STATISTICS_DISJOINT: return L"PRESENT STATISTICS DISJOINT";
    default:
        assert(0);
...
HRESULT WINAPI DXTrace(__in_z const WCHAR* strFile, __in DWORD dwLine, __in HRESULT hr, __in_z_opt const WCHAR* strMsg, __in BOOL bPopMsgBox)
{
    std::wostringstream o;
    o << strFile << "(" << dwLine << "): error 0x%X" << hr << ": '" << DXGetErrorString(hr);
    if (strMsg)
        o << " - " << strMsg;
    OutputDebugStringW(o.str().c_str());
    OutputDebugStringW(L"\n");
    if (bPopMsgBox)
        MessageBoxW(GetDesktopWindow(), o.str().c_str(), L"Error", MB_OK | MB_ICONERROR);
    return hr;
}
