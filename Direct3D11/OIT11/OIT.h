...
public:
    ...
    void    Render( ID3D11DeviceContext* pD3DContext, ID3D11Device* pDevice, CScene* pScene, XMMATRIX& mWVP, ID3D11RenderTargetView* pRTV, ID3D11DepthStencilView* pDSV);
    

private:
    void    CreateFragmentCount( ID3D11DeviceContext* pD3DContext, CScene* pScene, XMMATRIX& mWorldViewProjection, ID3D11RenderTargetView* pRTV, ID3D11DepthStencilView* pDSV );
    void    CreatePrefixSum( ID3D11DeviceContext* pD3DContext );
    void    FillDeepBuffer( ID3D11DeviceContext* pD3DContext, ID3D11RenderTargetView* pRTV, ID3D11DepthStencilView* pDSV, CScene* pScene, XMMATRIX& mWorldViewProjection );
