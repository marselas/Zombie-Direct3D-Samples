                                     ...
                                     void* /*pUserContext*/ )
{
    ...
    desc.ByteWidth = sizeof(initdata[0]) * static_cast<UINT>(initdata.size());
    ...
    g_Tessellator.SetBaseMesh( pd3dDevice, pd3dImmediateContext, static_cast<INT>(initdata.size()), g_pBaseVB );
    ...
    DXUT_SetDebugName( g_pVSCB, "XMFLOAT4X4" );
    ...
    XMVECTOR vecEye;
    vecEye = XMVectorSet(0, 0, -300, 0);
    XMVECTOR vecAt = XMVectorSet(10.0f, 20.0f, 0.0f, 0);
                                 ...
                                 float fElapsedTime, void* /*pUserContext */)
{
    ...
    XMStoreFloat4x4(&mWorldViewProjection, mWorld * mView * mProj);
    ...
    if ( g_bShowTessellated )
    {
        ...
        if ( num_tessed_vertices > 0 && num_tessed_indices > 0 )
        {
            ...
            XMFLOAT4X4* pMat = ( XMFLOAT4X4* )MappedResource.pData;  
