...
void CTessellator::PerEdgeTessellation( XMFLOAT4X4* matWVP,
                                        ...
                                        DWORD* num_tessed_vertices, DWORD* num_tessed_indices )
{
    ...
    // Tessellate indices
    {
        DWORD cbCS[4] = {*num_tessed_indices, 0, 0, 0};
