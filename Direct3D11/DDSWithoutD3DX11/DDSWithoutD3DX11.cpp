    ...
    void* /*pUserContext*/)
{
    ...
    V_RETURN(D3DCompileFromFile(str, NULL, &includeHandler, "RenderSceneVS", "vs_4_0_level_9_1", dwShaderFlags, 0,
        &pVertexShaderBuffer, NULL));

    ID3DBlob* pPixelShaderBuffer = NULL;
    V_RETURN(D3DCompileFromFile(str, NULL, &includeHandler, "RenderScenePS", "ps_4_0_level_9_1", dwShaderFlags, 0,
    ...
    XMVECTOR vecEye = XMVectorSet(0.0f, 0.0f, -5.0f, 0);
