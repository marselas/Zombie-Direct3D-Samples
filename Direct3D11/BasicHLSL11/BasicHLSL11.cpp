...
void InitApp()
{
    XMVECTOR vLightDir = XMVectorSet(-1, 1, -1, 0);
    ...
    void* /*pUserContext*/)
{
    ...
    XMVECTOR vecEye = XMVectorSet(0.0f, 0.0f, -100.0f, 0);
    ...
    float fElapsedTime, void* /*pUserContext*/)
{
    ...
    XMStoreFloat4(&pPerFrame->m_vLightDirAmbient, vLightDir);
    ...
    pVSPerObject->m_WorldViewProj = XMMatrixTranspose(mWorldViewProjection);

    pVSPerObject->m_World = XMMatrixTranspose(mWorld);
