...
// when these parameters change, we must reallocate the shadow resources.
...
struct CB_ALL_SHADOW_DATA
{
    ...
    XMFLOAT4X4A  m_World;
    XMFLOAT4X4A  m_WorldView;
    XMFLOAT4X4A  m_Shadow;
    ...
    FLOAT       m_fCascadeFrustumsEyeSpaceDepths[8]; // The values along Z that separate the cascades.
