...
void CALLBACK OnFrameMove( double fTime, float fElapsedTime, void* pUserContext )
{
    ...
    if( g_bRandomizeColor )
    {
        ...
        {
            g_vParticleColor.x = static_cast<float>(fabs( RPercent() ));
            g_vParticleColor.y = static_cast<float>(fabs( RPercent() ));
            g_vParticleColor.z = static_cast<float>(fabs( RPercent() ));
